...
\smallskip
      ...
      \mybullet Performed semantic analysis and canonicalization on raw data in using NLTK and Python. \\
      \mybullet Trained and tested neural machine translation model using TensorFlow in Python and in Theano. \\
