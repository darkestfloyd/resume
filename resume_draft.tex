...
%	\noindent
%	\textbf{LoomKars} \hfill May-June 2016 \\
%	\mybullet Designed application using JSP as part of local non-profit venture that helped students rent vehicles from other students. \\	
...
%	\mybullet Earned ``Documentation Pioneer'' badge on StackOverflow for being one of the initial backers and contributers on topics in RxJava on StackOverflow Documentation. \\
